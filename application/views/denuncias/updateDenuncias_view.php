 ...
 <main class="pt-5 mx-lg-5">
   ...
   <?php
                        ...
                        echo form_open(base_url('Admin/updateDenuncia'), 'class="form-horizontal" entype="multipart/formdata"');
                        ?>
       ...
       <div class="col-sm-12">
         ...
         <ul class="list-group">
           ...
           <li class="list-group-item ">
             <div class="row">
               <div class="col">
                 <div class="row-fluid">
                   <select class="selectpicker" data-show-subtext="true" data-live-search="true"  name="denunciaPasoUno" value="<?=$data->denunciaPasoUno?>" required>
               ...
               <div class="col">
                 <div class="row-fluid">
                   <select class="selectpicker" data-show-subtext="true" data-live-search="true" name="denunciaPasoDos"  value="<?=$data->denunciaPasoDos?>"required>
               ...
               <div class="col">
                 <div class="row-fluid">
                   <select class="selectpicker" data-show-subtext="true" data-live-search="true" name="denunciaPasoTres"  value="<?=$data->denunciaPasoTres?>" required>
         ...
         <ul class="list-group">
           ...
           <li class="list-group-item  cyan lighten-5">
             <div class="row">
               <div class="col">
                 <input type="text" class="form-control" placeholder="Nombre Y Apellido" name="nombreCompleto"  value="<?=$data->nombreCompleto?>" required>
               </div>
               <div class="col">
                 <input type="text" class="form-control" placeholder=" Ingrese CI"  name="ci"  value="<?=$data->ci?>" required>
               </div>
               <div class="col">
                 <input type="text" class="form-control" placeholder="Ingrese Ciudad"  name="ciudad"  value="<?=$data->ciudad?>"required>
               </div>
             </div>
             <br>
             <div class="row">
               <div class="col">
                 <input type="text" class="form-control" placeholder="Ingrese Correo Electronico"  name="correoElectronico"  value="<?=$data->correoElectronico?>" required>
               </div>
               <div class="col">
                 <input type="text" class="form-control" placeholder=" Ingrese Telefono"  name="telefono"  value="<?=$data->telefono?>" required>
               </div>
             </div>
           </li>
         </ul><br>
         ...
         <ul class="list-group">
           ...
           <li class="list-group-item  cyan lighten-5">
             <div class="row">
               <div class="col">
                 <input type="text" class="form-control" placeholder="Nombre Y Apellido"  name="nombreDenunciado"  value="<?=$data->nombreDenunciado?>" required>
               </div>
               <div class="col">
                 <input type="text" class="form-control" placeholder="Dirección General"  name="direccionDenunciado"  value="<?=$data->direccionDenunciado?>" required>
               </div>
             </div><br>
             <div class="row">
               <div class="col">
                 <input type="text" class="form-control" placeholder="Unidad"  name="unidadDenunciado"  value="<?=$data->unidadDenunciado?>" required>
               </div>
               <div class="col">
                 <input type="text" class="form-control" placeholder="Cargo Que Ocupa"  name="cargoDenunciado"   value="<?=$data->cargoDenunciado?>" required>
               </div>
             </div>
           </li>
         </ul>
         ...
         <ul class="list-group">
           ...
           <li class="list-group-item light-blue lighten-5">
             ...
             <div class="col">
               ...
               <textarea name="hechosDenuncia" class="form-control" ><?php echo $data->hechosDenuncia; ?></textarea>
             ...
             <div class="row">
               <div class="col">
                 <select class="browser-default custom-select">
                   <option selected  name="pruebasDocumentos"  value="<?=$data->pruebasDocumentos?>" required >Documento</option>
                   <option value="Si">Si</option>
                   <option value="No">No</option>
                 </select>
               </div>
               <div class="col">
                 <input type="number" class="form-control" placeholder="Numero de Hojas" name="numeroHojas" value="<?=$data->numeroHojas?>">
               </div>
               <div class="col">
                 <select class="browser-default custom-select">
                   <option selected  name="claseDocumento"  value="<?=$data->claseDocumento?>" required>Clase De Documento</option>
               ...
               <div class="col">
                 <input type="date" class="form-control" placeholder="Unidad"  name="fechaRegistro"  value="<?=$data->fechaRegistro?>" required>  
               </div>
             </div><br>
             <div class="row">
               <div class="col">
                 <div class="form-group green-border-focus">
                 <textarea name="otrasPruebas" class="form-control" ><?php echo $data->otrasPruebas; ?></textarea>
                                  </div>
               </div>
             </div>
           </li>
         ...
         <input type="hidden" name="idformularioDenuncia" value="<?=$data->idformularioDenuncia?>">
